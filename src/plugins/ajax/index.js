...
const globalOptions = {
  ...
  // baseURL: 'https://192.168.101.57/',
  // baseURL: 'https://192.168.101.58/',
  // baseURL: 'https://192.168.101.64/',
  // baseURL: 'https://192.168.211.68/',
  // baseURL: 'http://192.168.211.211:8111/',
  // baseURL: 'https://192.168.211.213/',
  // baseURL: 'https://192.168.211.214/',
  // baseURL: 'https://192.168.211.217/',
  // baseURL: 'https://192.168.211.218/',
  // baseURL: 'http://192.168.211.220/',
  // baseURL: 'https://192.168.211.221/',
  // baseURL: 'https://192.168.211.231/',
  // baseURL: 'https://192.168.211.232/',
  // baseURL: 'https://192.168.211.233/',
  baseURL: 'http://192.168.212.22:8081/',
  // baseURL: 'http://192.168.212.39/',
  // baseURL: 'https://192.168.212.41/',
  // baseURL: 'http://192.168.212.46:8080/',
  // baseURL: 'http://192.168.212.52/',
  // baseURL: 'http://192.168.212.58:8080/',
  // baseURL: 'http://192.168.212.130:8080/',
  // baseURL: 'https://192.168.212.132/',
  // baseURL: 'http://192.168.212.138:8080/',
  // baseURL: 'https://192.168.212.140:8080/',
  // baseURL: 'https://192.168.212.141/',
  timeout: 60000,
  headers: {
    'axios-header': 'axios'
  }
